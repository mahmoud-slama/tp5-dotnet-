...
namespace RestoManager_X.Controllers
{
    public class AvisController : Controller
    {
        ...
        public async Task<IActionResult> RestaurantsAvecBonneNote()
        {
        ...
        {
            var avis = await _context.Avis.Where(a => a.NumResto == id).ToListAsync();
            return View(avis);
        }
        public async Task<IActionResult> AvisParRestaurant()
        {
            var restaurants = await _context.Restaurants.Include(r => r.LesAvis).ToListAsync();
            return View(restaurants);
        }
